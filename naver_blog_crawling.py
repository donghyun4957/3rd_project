...
from blog_crawling import get_content
import json
...
for kw in common_keyword:
    ...
    for start in range(1, 101, 10):
        ...
        url = f"https://openapi.naver.com/v1/search/blog.json?query={encText}&display=10&start={start}"
        ...
        if(rescode==200):
            ...
            for item in result["items"]:
                ...
                if blog_content != "내용 없음":
                        content = {'제목': item['title'], '내용': blog_content, '블로그': item['bloggerlink'], '링크': link}
